...
const TestCompFullOpacity = ({ className }) => {
  ...
  const circles = [
    {
      title: "ვიზიტორი",
      icon: (
        <PersonStanding className="size-6 text-white sm:size-8 md:size-9 2xl:size-12" />
      ),
    },
    {
      title: "ძიება",
      icon: (
        <Search className="size-6 text-white sm:size-8 md:size-9 2xl:size-12" />
      ),
    },
    {
      title: "შერჩევა",
      icon: (
        <FileCheck className="size-6 text-white sm:size-8 md:size-9 2xl:size-12" />
      ),
    },
    {
      title: "დაკავშირება",
      icon: (
        <PhoneCall className="size-6 text-white sm:size-8 md:size-9 2xl:size-12" />
      ),
    },
    {
      title: "შეთანხმება",
      icon: (
        <Handshake className="size-6 text-white sm:size-8 md:size-9 2xl:size-12" />
      ),
    },
    {
      title: "შეძენა",
      icon: (
        <CheckCircle className="size-6 text-white sm:size-8 md:size-9 2xl:size-12" />
      ),
    },
  ];
    ...
    <div ref={ref} className={cn("", className)}>
      <div className="flex flex-col items-center gap-y-6 pb-8 pt-16 sm:pb-0">
        ...
        >
          <div
            className={cn(
              "absolute top-12 z-0 h-1.5 w-full rounded-full bg-[#68A249]",
              shouldAnimate && "line-5",
            )}
          />
          {circles.map((e, i) => (
            <div
...
export default TestCompFullOpacity;
